...
export const CardFace = (props: { className?: string; isLegend?: boolean; cardFace: string; children?: JSX.Element }) => {
  ...
  return (
    <div class={`card-face-component ${props.className ?? ''}`}>
      ...
      <div class="card-face">
        ...
        <img src={props.isLegend ? CARD_LEGEND_FRAME : CARD_NORMAL_FRAME} class="card-frame" />
        {props.children}
      </div>
    </div>
  );
